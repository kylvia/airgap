...
describe("renderHtml", () => {
  ...
  it("Evergreen 聊天风要素：linen/bone/ink/sage tokens、深色媒体查询、页脚署名", () => {
    expect(html).toContain("prefers-color-scheme: dark");
    expect(html).toContain("--color-linen-canvas:");
    expect(html).toContain("--color-bone-card:");
    expect(html).toContain("--color-ink:");
    expect(html).toContain("--color-sage:");
